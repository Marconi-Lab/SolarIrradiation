...
class ModisConfig:
    ...
    @staticmethod
    def get_product_request_url(product_name: str, latitude: float, longitude: float, band_name: str, start_date: datetime,
                                end_date: datetime, kmAB: int = 1, kmLR: int = 1) -> str:
    ...
    @staticmethod
    def get_available_date_url(product_name: str, latitude:float, longitude: float) -> str:
