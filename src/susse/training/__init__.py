"""Training orchestration — Trainer, TrainedBundle, splitter hierarchy.

Public entry points:

* :class:`Trainer`, :class:`TrainerConfig` — the orchestrator that
  takes a :class:`PreprocessedDataset` + :class:`BaseModelParams` +
  :class:`Splitter` and returns a :class:`TrainedBundle`.
...
* :class:`Splitter` and the five concrete subclasses
  (:class:`RandomSplitter`, :class:`TemporalSplitter`,
  :class:`StationLOSOSplitter`,
  :class:`SpatialSpreadHoldoutSplitter`,
