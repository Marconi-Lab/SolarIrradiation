...
class NasaPowerJob:
    ...
    def run(self) -> None:
        ...
        if self.locations is None:
            ...
            locs = self.locations
        latest = sat.latest_date(TABLES.nasa_daily_vars_long)
        ...
        load_long_with_merge(self.bq, out, TABLES.nasa_daily_vars_long)
        logger.info("NASA POWER load completed: %d rows", len(out))
