...
| a8 | _(notebook edit)_ | Add audit and pair-assertion cells to `warehouse/extending_the_warehouse.ipynb` between the warehouse-tour and Pattern-1 sections. | applied |
...
| a12 | [`2026-06-24_a12_ingest_katongole_2017_2022.py`](./2026-06-24_a12_ingest_katongole_2017_2022.py) | Ingest NASA POWER + CAMS at the 54 Katongole 2023 stations over 2017-2022. Required by the recomputation notebook before it can compute a multi-year climatology matching Katongole's published window. | drafted |
| a13 | [`2026-05-13_a13_ingest_uganda_full_nasa.py`](./2026-05-13_a13_ingest_uganda_full_nasa.py) | Ingest NASA POWER for the entire Uganda bbox at 0.04° (~geohash5-width) grid step for 2024. Brings NASA coverage from ~1962 cells (training-station footprint) to ~21,000 cells so the portal's `on_cache_miss="raise"` path works for any Uganda click. ~40k NASA POWER API calls; 6–25 h wall time depending on latency; resumable. | drafted |
...
| c3 | [`2026-05-08_c3_create_modis_observations.py`](./2026-05-08_c3_create_modis_observations.py) | Create the empty `modis_observations` table from its DDL. | applied |
| c7 | [`2026-05-08_c7_populate_dim_variable_modis.py`](./2026-05-08_c7_populate_dim_variable_modis.py) | Extend `dim_variable` with the 3 MODIS catalog entries (MCD43A4, MOD11A2, MOD13Q1). | applied |
| c8 | [`2026-05-08_c8_ingest_modis_stations_and_grid.py`](./2026-05-08_c8_ingest_modis_stations_and_grid.py) | Ingest MODIS composites from ORNL DAAC for the 28 ground stations and the Uganda 2024 grid. | applied |
