...
| a8 | _(notebook edit)_ | Add audit and pair-assertion cells to `notebooks/tutorial/01_warehouse_population.ipynb` between the warehouse-tour and Pattern-1 sections. | applied |
